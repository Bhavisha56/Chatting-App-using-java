...
public class Quiz extends JFrame implements ActionListener {
    ...
    String useranwers[][] = new String[10][1];
    ...
    Quiz(String name) {
        ...
        qna = new JLabel();
        qna.setBounds(100, 450, 50, 30);
        qna.setFont(new Font("Tahoma", Font.PLAIN, 24));
        add(qna);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == next) {
            ...
            if (group.getSelection() == null) {
                ...
                useranwers[count][0] = group.getSelection().getActionCommand();
            }
            if (count == 8) {
            ...
            for (int i = 0; i < useranwers.length; i++) {
                if (useranwers[i][0].equals(answers[i][1])) {
                    score += 10;
                } else {
                    score += 0;
                }
